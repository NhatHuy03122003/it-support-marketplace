        ...
        >
          <div className="bg-white rounded-3xl p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50">
            ...
            <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full bg-[#E82323] text-white font-bold text-sm py-3.5 rounded-full shadow-lg shadow-primary/20 hover:bg-primary-hover transition-all duration-200"
              >
            ...
            {/* <div className="space-y-3">
              <button className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-full border border-gray-200 hover:bg-gray-50 transition-colors active:scale-95 duration-200 group">
                <img 
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuC44ETGKCncnhkDxz-E2gE_YZR1Ev10p0IPBZUFyLrZat_AM8OF1tLcVuPV_U4qaFcFDJIz4LsR8XxXacTRKEKh4Qt5eJEBgo-1I9TlmSGFn7Omx3PbXTJurL3fFA1BaimHFF9VBN94a1Rp0Q1dVb8T9eObTtMMp-upqKvkPU39IPsAU8bBwqSn_5OQ0SRW85A78-qYxk8HIQiRbsOdvETxpe_b4PaqwkN9soN-PjUwv6BfCl4591dalPIhoq-A9ZZawOLKOkyFI0c" 
                  alt="Google" 
                  className="w-5.5 h-5.5 object-contain"
                  referrerPolicy="no-referrer"
                />
                <span className="text-[13px] font-bold text-black group-hover:text-primary transition-colors">Google</span>
              </button>
            </div> */}
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-500 text-[13px] font-medium">
                Chưa có tài khoản? 
                <a href="#" className="text-black font-extrabold hover:underline ml-1 transition-all">
                  Đăng ký ngay
                </a>
              </p>
            </div>
